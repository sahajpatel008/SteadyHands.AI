...
Hack4Humanity hackathon repo. For navigating the web for the not-so-tech peeps.
...
See `backend/` and `frontend/` for the original Hack4Humanity project structure.
